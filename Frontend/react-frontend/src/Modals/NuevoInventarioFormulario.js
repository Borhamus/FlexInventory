...
export default function NuevoInventarioFormulario() {
  ...
  const handleFormSubmit = async (event) => {
   ...
   const fields = [
    { label: "Nombre del Inventario", type: "text", placeholder:"Nombre del Inventario..." },
    { label: "Descripcion del Inventario", type: "text", placeholder:"Descripcion del inventario..."},
    { label: "Fecha de revision", type: "date", placeholder:""},
  ];
