...
// La tabla NO resalta filas por notificaciones. Se sacó el pintado (rojo =
// fuera de rango/vencido, amarillo = por vencer) porque duplicaba en el
// cliente el criterio del motor del backend (app/notificaciones/motor.py) y
// las dos copias se desincronizaban: "vencido" se pintaba con solo tener el
// atributo bajo vigilancia, sin regla configurada, así que una fila a la que
// ya se le había sacado la notificación seguía apareciendo en rojo. El estado
// de las notificaciones vive en un solo lugar: el centro de avisos
// (NotificacionesPage), alimentado por ese motor.
