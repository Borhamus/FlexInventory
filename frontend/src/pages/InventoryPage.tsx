...
const InventoryPage: React.FC = () => {
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <ModalEditInventory isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} inventoryId={Number(id)} currentName={data?.nombre || ''} currentAtributos={data?.atributos || {}} currentUnidades={data?.unidades || {}} currentRolesAtributos={data?.roles_atributos || {}} currentFotosHabilitadas={data?.fotos_habilitadas} currentNotificacionesConfig={data?.notificaciones_config || {}} />
