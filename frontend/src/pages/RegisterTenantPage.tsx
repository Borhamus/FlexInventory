...
import { Layout, Card, Form, Input, Button, Typography, theme, ConfigProvider } from 'antd';
    ...
    <ConfigProvider theme={{ algorithm: theme.defaultAlgorithm }}>
      <Layout style={{ minHeight: '100vh',
        ...
        <Content style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <Card
            style={{ width: 600, boxShadow: '0 4px 12px rgba(0,0,0,0.1)', borderRadius: '8px', backgroundColor: 'rgba(255, 255, 255, 0.90)', backdropFilter: 'blur(10px)'}}
          >
            ...
            <div style={{ textAlign: 'center' }}>
              <Text type="secondary">¿Ya tenés una cuenta? <Link to="/login">Iniciá sesión</Link></Text>
            </div>
          </Card>
        </Content>
      </Layout>
